...
var sggLayer;
	...
	$(document).ready(function() {
						$('#sdSelect').change(function() {
											...
											updateAddress(sdSelectedText, null); // 상단 주소창에 선택한 시/도 노출
											...
											// ssgSelect를 초기화
											//$('#sggSelect').empty().val(null).trigger('change');
						...
						$('#sggSelect').change(function() {
											...
											if(sggSelectedValue) {
												...
												updateAddress(null, sggSelectedText); //상단 시/군/구 노출
						...
						function updateAddress(sd, sgg) {
					        ...
					        // 주소 업데이트
					        $('#address').html('<h1>' + sdValue + ' ' + sggValue + '</h1>');
						}
